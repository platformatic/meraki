...
export const STEP_PREPARE_FOLDER = 'STEP_PREPARE_FOLDER'
...
export const STEP_UPDATING_APPLICATION = 'STEP_UPDATING_APPLICATION'
...
export const LIST_TEMPLATES_VIEW = 'list_templates'
