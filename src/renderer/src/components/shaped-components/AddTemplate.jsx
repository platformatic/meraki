...
const AddTemplate = React.forwardRef(({ onClickAddTemplate }, ref) => {
  return (
    <div className={`${styles.container} cy-add-template`} onClick={() => onClickAddTemplate()} ref={ref}>
      <svg viewBox='0 0 264 324' fill='none' preserveAspectRatio='none' xmlns='http://www.w3.org/2000/svg' className={styles.svg}>
        <path
