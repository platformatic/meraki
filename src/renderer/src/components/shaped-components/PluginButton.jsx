...
function PluginButton ({
  ...
  return (
    <div className={`${styles.container} ${getSpecificContainerClassName()}`} ref={ref}>
      <svg viewBox='0 0 284 102' preserveAspectRatio='none' fill='none' xmlns='http://www.w3.org/2000/svg' className={styles.svg}>
        {index === 0
          ? <BrickPath width={284} height={102} />
        /* <path
          d='M261.5 12.6544
          V101.114
        ...
        /> */
          : (
            <>
              <rect x={0.5} y={0.61377} rx={3.5} fill='none' className={styles.rectFilled} />
              <rect x={0.5} y={0.61377} rx={3.5} stroke='none' className={styles.rectBordered} />
            </>
            )}
      </svg>
