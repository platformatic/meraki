...
function StopApplicationToUpgrade ({ onClickCancel, onClickProceed }) {
  ...
  return (
    <div className={`${commonStyles.mediumFlexBlock} ${commonStyles.fullWidth}`}>
      <p className={`${typographyStyles.desktopBody} ${typographyStyles.textWhite} ${commonStyles.fullWidth} ${typographyStyles.opacity70}`}>
        To upgrade the Platformatic version of this application, it needs to be stopped.<br /><br />If you want to proceed, we stop the application for you.
      </p>
...
StopApplicationToUpgrade.propTypes = {
  /**
   * onClickCancel
   */
...
StopApplicationToUpgrade.defaultProps = {
  onClickCancel: () => {},
  onClickProceed: () => {}
}

export default StopApplicationToUpgrade
