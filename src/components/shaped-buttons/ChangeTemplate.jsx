...
const ChangeTemplate = React.forwardRef(({ onClick, name }, ref) => {
  return (
    <div className={styles.container} onClick={() => onClick()} ref={ref}>
      <svg width={264} height={288} viewBox='0 0 264 288' fill='none' xmlns='http://www.w3.org/2000/svg' className={styles.svg}>
